...
import com.zjrtc.activities.ZJVideoShiTongActivity;
import com.zjrtc.activities.ZJVideoSimulcastActivity;
import com.zjrtc.activities.ZJVideoTVActivity;
import com.zjrtc.entities.Call;
import com.zjrtc.utils.SystemUtil;
import com.zjrtc.utils.ZJUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void joinConference(View view) {
        ...
        call.setCheckDup(ZJUtil.MD5(SystemUtil.getMac(this) + etName.getText().toString()));
        ...
        if (prefs.isShiTongPlatform()) {
            intent = new Intent(this, ZJVideoShiTongActivity.class);
        } else {
            if (sTV.isChecked()) {
                intent = new Intent(this, ZJVideoTVActivity.class);
            } else {
